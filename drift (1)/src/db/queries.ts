...
export async function dropNote(userId: string, latitude: number, longitude: number, content: string, writtenWeather: string | null = null, writtenTime: string | null = null) {
